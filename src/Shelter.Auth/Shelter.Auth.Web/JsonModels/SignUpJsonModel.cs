...
{
	[DataContract]
	public class SignUpJsonModel : IValidatableObject
	{
		...
		public IEnumerable<ValidationResult> Validate(ValidationContext validationContext)
		{
			...
			validationContext.Validate(this, x => x.Email)
				.If(email => !email.IsValidEmailAddress())
				.Add<AuthValidation>(x => x.SignUp.InvalidEmail);
